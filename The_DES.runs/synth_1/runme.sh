...
HD_PWD='C:/Users/sarth/Documents/IHI_proj/The_DES/The_DES.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log The_DES.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source The_DES.tcl
