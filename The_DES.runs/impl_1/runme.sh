...
HD_PWD='C:/Users/sarth/Documents/IHI_proj/The_DES/The_DES.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log The_DES.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source The_DES.tcl -notrace
